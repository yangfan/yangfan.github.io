...
img: /assets/img/projects/path-planning/a-star/a5.gif
importance: 1
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/dijkstra.gif'| relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/dijkstra_planning.png'| relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a1.gif'| relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a_1.png'| relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a2.gif'| relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a_2.png'| relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a5.gif'| relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a_5.png'| relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a10.gif'| relative_url }}" alt="" title="example image"/>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        <img class="img-fluid rounded " src="{{ '/assets/img/projects/path-planning/a-star/a_10.png'| relative_url }}" alt="" title="example image"/>
    </div>
</div>
<div class="caption">
...
<div class="repositories d-flex flex-wrap flex-md-row flex-column justify-content-between align-items-center">
  {% include repository/repo.liquid repository="yangfan/probabilitics-robotics/tree/master/Path_planning" %}
</div>

...
img: /assets/img/projects/mapping/ogm/cover.gif
importance: 1
...
<div class="row justify-content-center">
    <div class="col">
        <div class="w-50 mx-auto" style="background-color: white;">
            <img class="img-fluid" src="{{ '/assets/img/projects/mapping/ogm/gridmap-s1.gif' | relative_url }}" alt=""/>
        </div>
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col">
        <div class="w-50 mx-auto" style="background-color: white;">
            <img class="img-fluid" src="{{ '/assets/img/projects/mapping/ogm/occupancy-grid-alg.png' | relative_url }}" alt=""/>
        </div>
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col">
        <div class="w-50 mx-auto" style="background-color: white;">
            <img class="img-fluid" src="{{ '/assets/img/projects/mapping/ogm/gridmap-s5.gif' | relative_url }}" alt=""/>
        </div>
    </div>
</div>
<div class="caption">
...
<div class="repositories d-flex flex-wrap flex-md-row flex-column justify-content-between align-items-center">
  {% include repository/repo.liquid repository="yangfan/probabilitics-robotics/tree/master/Grid_map" %}
</div>
